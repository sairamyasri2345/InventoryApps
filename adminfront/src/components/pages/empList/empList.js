  ...
  const EmployeeManagement = ({ darkMode, filterText }) => {
    ...
    //     }
    //   } else {
    //     // Mark all fields as touched when saving to show error messages
    //     setTouchedFields({
    //       name: true,
    //       employeeID: true,
    //       email: true,
    ...
    {passwordCardVisible && (
      <div className="card mt-2 p-3">
        ...
        <ul>
          <li
            className={
              passwordConditions.length ? "text-success" : "text-danger"
            }
          >
          ...
          <li
            className={
              passwordConditions.uppercase ? "text-success" : "text-danger"
            }
          >
          ...
          <li
            className={
              passwordConditions.lowercase ? "text-success" : "text-danger"
            }
          >
            At least one lowercase letter
          </li>
          <li
            className={passwordConditions.number ? "text-success" : "text-danger"}
          >
            At least one number
          </li>
          <li
            className={
              passwordConditions.special ? "text-success" : "text-danger"
            }
          >
            At least one special character
                      ...
                      <Form.Group className="mb-2">
                        ...
                        />
                        {(touchedFields.department || !employeeData.department) &&
                    ...
                    <tbody>
                      {filteredEmployees.map((employee) => (
                        <tr key={employee._id}>
                          ...
                          <td className="text-center">{employee.email}
