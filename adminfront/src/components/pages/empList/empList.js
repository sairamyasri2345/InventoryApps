...
const EmployeeManagement = ({ darkMode, filterText }) => {
  ...
  const fetchDepartment = async () => {
    try {
      const deptRes = await axios.get("https://inventoryappsatmos-1xdp.onrender.com/api/depts/depts");
  ...
  const fetchEmployees = async (page = 1, limit = pageSize) => {
    try {
      ...
      const response = await axios.get("https://inventoryappsatmos-1xdp.onrender.com/api/employees", {
      ...
      try {
        if (editMode) {
          ...
          const response = await axios.put(
            `https://inventoryappsatmos-1xdp.onrender.com/api/employees/${currentEmployee._id}`,
            employeeData
          );
          ...
          const response = await axios.post(
            "https://inventoryappsatmos-1xdp.onrender.com/api/employees/add-employee",
            employeeData
          );
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`https://inventoryappsatmos-1xdp.onrender.com/api/employees/${id}`);
